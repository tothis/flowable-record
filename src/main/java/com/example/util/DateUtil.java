...
public class DateUtil {
     ...
     * @return
     * @date 2019/09/29 09:40
     * @Description 将时间字符串 转成date类型
     */
    public static Date parseDate(String str) {
        TemporalAccessor date = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss").withZone(ZoneId.systemDefault()).parse(str);
    ...
    public static boolean isCurrentAM() {
        return LocalTime.now().getHour() - 12 < 0;
    }
